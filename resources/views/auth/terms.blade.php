    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">TÉRMINOS DE SERVICIO</h3>
            </div>

            <div class="modal-body" style="overflow-x:auto; height: 300px; text-align : justify;">


                <p>INFORMACIÓN GENERAL</p>

                <p>Este sitio web es operado por kehila mesianica vive la toráh. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a kehila mesianica vive la toráh. kehila mesianica vive la toráh ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
                ...
                Nuestra tienda se encuentra alojada en Shopify Inc. Ellos nos proporcionan la plataforma de comercio electrónico en línea, que nos permite venderte nuestros productos y servicios.</p>
               ...
               <p>Al utilizar este sitio, declaras que tienes al menos la mayoría de edad en tu estado o provincia de residencia, o que tienes la mayoría de edad en tu estado o provincia de residencia y que nos has dado tu consentimiento para permitir que cualquiera de tus dependientes menores use este sitio.
                ...
                <p>SECCIÓN 3 - EXACTITUD, EXHAUSTVIDAD Y ACTUALIDAD DE LA INFORMACIÓN</p>
                ...
                <p>SECCIÓN 9 - COMENTARIOS DE USUARIO, CAPTACIÓN Y OTROS ENVÍOS</p>
                ...
                <p>Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de ignacio centeno 101, celaya, GUA, 38020, Mexico.</p>
                ...
                <p>Preguntas acerca de los Términos de Servicio deben ser enviadas a contacto@vivelatorah.org.</p>
            </div>
